...
while(True):
    ...
    cv2.putText(bordas_color,'',(0,50), font, 2,(255,255,255),2,cv2.LINE_AA)
...
# When everything done, release the capture
    ...
    img2 = blur           # Imagem do cenario - puxe do video para fazer isto
    ...
    if len(good)>MIN_MATCH_COUNT:
        ...
        # Desenha as linhas
        img2b = cv2.polylines(bordas_color,[np.int32(dst)],True,255,3, cv2.LINE_AA)
